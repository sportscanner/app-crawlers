...
class TowerHamletsBadmintonRequestStrategy(AbstractRequestStrategy):
    """
    ...
    def generate_request_details(
        ...
        for params in activityIdsLookupForSiteIds:
            ...
            booking_url_template = (
                "https://towerhamletscouncil.gladstonego.cloud/book/calendar/"
...
class TowerHamletsCrawler(BaseCrawler):
    def __init__(self):
        super().__init__(
