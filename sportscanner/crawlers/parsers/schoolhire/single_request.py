...
def parse_calendar_response(response):
    ...
    # Extract dates
    dates = [th.text.strip() for th in soup.find('tr', class_='week-head').find_all('th')]
...
if __name__ == "__main__":
    ...
    for fetch_date in week_startdates_for_request:
        ...
        url = (
            f"https://schoolhire.co.uk/calendar.json?facility_id={venue_id}&date={RFC850_date_format}"
        )
