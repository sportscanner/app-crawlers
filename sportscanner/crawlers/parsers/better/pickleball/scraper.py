...
class BetterLeisureCrawler(BetterStyleCrawler):
    def __init__(self):
        super().__init__(
            request_strategy = BetterLeisurePickleballRequestStrategy(),
...
def coroutines(search_dates: List[date]):
    return BetterLeisureCrawler().coroutines(search_dates, sport="pickleball", delta=6)
...
if __name__ == "__main__":
    ...
    _sport_venues_composite_ids = ["d3e1e00e", "7024649e"]
